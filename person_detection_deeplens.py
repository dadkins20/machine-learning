                ...
                if obj['label'] == 15:
                    if (obj['prob'] > detection_threshold) and (pause == 0):
                        ...
                        s3.upload_file(
                            ...
                            'detected-deeplens-'+timestamp+".jpg",
                        ...
                        post_params = {"To": twilio_my_number, "From": twilio_number, "Body": "Person detected.", "MediaUrl": 'https://deeplens-sagemaker-davidadkins.s3.amazonaws.com/detected-deeplens-'+timestamp+'.jpg'}
                        ...
                        try:
                            ...
                            client.publish(topic=iot_topic, payload="Twilio returned {}".format(str(f.read().decode('utf-8'))))
                        except Exception as e:
                            # something went wrong!
                            client.publish(topic=iot_topic, payload="Twilio error: {}".format(e))
